...
a <- as.data.frame(Ferus_MERS@assays$RNA@counts@Dimnames[[1]])
...
df1 <- Ferus_MERS@meta.data %>% select(c("celltype","Total.DPP4.Counts", "Total.ANPEP.Counts", "Status", "Treat", "DPP4_Status", "ANPEP_Status"))
