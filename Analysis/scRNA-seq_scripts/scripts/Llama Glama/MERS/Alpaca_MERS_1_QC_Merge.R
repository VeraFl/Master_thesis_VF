...
for (file in c("mock_filtered_feature_bc_matrix", "inf_filtered_feature_bc_matrix")){
  seurat_data <- Read10X(data.dir = paste0("data/L. Glama/MERS_exon/", file))
...
tail(counts_per_gene_inf, 25)
tail(counts_per_gene_mock, 25)

#show the specific location in the matrix for control
inf_filtered_feature_bc_matrix@assays$RNA@counts[28366:28377,]

#take the right rows in the matrix
Infected_viral_counts <- as.matrix(inf_filtered_feature_bc_matrix@assays$RNA@counts[28366:28377,])
Mock_viral_counts <- as.matrix(mock_filtered_feature_bc_matrix@assays$RNA@counts[28366:28377,])
...
plot(sort(Infected_viral_percentage), ylim = c(0, 0.9), xlim = c(0, 4500), xlab='cell', main='MERS.Percentage vs cell (ordered) - MERS infected')
plot(sort(Infected_viral_percentage), ylim = c(0, 0.01), xlim = c(0, 4500), xlab='cell', main='MERS.Percentage vs cell (ordered) - MERS infected')
plot(sort(Mock_viral_percentage), ylim = c(0, 0.9),xlim = c(0, 4500), xlab='cell', main='MERS.Percentage vs cell (ordered) - MERS Mock')
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/threshold_mers_infection.png",
...
10^(-1.7520081)
#mers Infection threshold: 0.01770076

#Threshold above 0.002 Percent Viral is infected

inf_filtered_feature_bc_matrix@meta.data <- inf_filtered_feature_bc_matrix@meta.data %>% mutate(Status = case_when(Percent.MERS > 0.01770076 ~ "Infected",
                                                                                                                   Percent.MERS <= 0.01770076 ~ "Non-infected"))
...
# VlnPlot(inf_filtered_feature_bc_matrix, features = c("Percent.Viral", "Total.Viral.Counts"), ncol = 2)
# VlnPlot(inf_filtered_feature_bc_matrix, features = c("Percent.Viral", "Total.Viral.Counts"), y.max = 0.8, ncol = 2)
# #mock
...
#Plots for QC
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/cell_numbers_per_virus_before_filtering.png",
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/UMI_per_cell_density_log_before_filtering.png",
    width=600, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/genes_per_cell_density_log_before_filtering.png",
    width=600, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/complexity_log_before_filtering.png",
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/Mitochondrial_content_density_before_filtering.png",
    width=700, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/correlation_gene_UMI_log_before_filtering.png",
...
#Plots for QC
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/cell_numbers_per_virus_after_filtering.png",
    width=600, height=500)
metadata_count %>% 
  ggplot(aes(x=Treat, y=n, fill=Status)) + 
  geom_col() +
...
#Number of UMI (transcripts) per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/UMI_per_cell_density_log_after_filtering.png",
    width=600, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=nUMI, fill= Treat)) + 
  geom_density(alpha = 0.6) + 
...
#Number of Genes per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/genes_per_cell_density_log_after_filtering.png",
    width=600, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=nGene, fill= Treat)) + 
  geom_density(alpha = 0.6) +
...
#Complexity
# Visualize the overall complexity of the gene expression by visualizing the genes detected per UMI (novelty score)
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/complexity_log_after_filtering.png",
    width=700, height=500)
metadata %>%
  ggplot(aes(x=log10GenesPerUMI, color = Treat, fill=Treat)) +
  geom_density(alpha = 0.6) +
...
# Visualize the distribution of mitochondrial gene expression detected per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/Mitochondrial_content_density_after_filtering.png",
    width=700, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=percent.mt, fill=Treat)) + 
  geom_density(alpha = 0.6) + 
...
# Visualize the correlation between genes detected and number of UMIs and determine whether strong presence of cells with low numbers of genes/UMIs
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_MERS/correlation_gene_UMI_log_after_filtering.png",
    width=1000, height=500)
metadata %>% 
  ggplot(aes(x=nUMI, y=nGene, color = Treat)) + 
  geom_point() + 
