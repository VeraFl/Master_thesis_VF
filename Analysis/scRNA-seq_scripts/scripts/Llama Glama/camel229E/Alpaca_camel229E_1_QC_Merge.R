...
for (file in c("mock_filtered_feature_bc_matrix", "inf_filtered_feature_bc_matrix")){
  seurat_data <- Read10X(data.dir = paste0("data/L. Glama/camel229E_exon/", file))
...
inf_filtered_feature_bc_matrix@assays$RNA@counts[28366:28375,]

#take the right rows in the matrix
Infected_viral_counts <- as.matrix(inf_filtered_feature_bc_matrix@assays$RNA@counts[28366:28375,])
Mock_viral_counts <- as.matrix(mock_filtered_feature_bc_matrix@assays$RNA@counts[28366:28375,])
...
inf_filtered_feature_bc_matrix <- AddMetaData(object = inf_filtered_feature_bc_matrix, metadata = infected.total.viral.counts, col.name = "Total.camel229E.Counts")
inf_filtered_feature_bc_matrix <- AddMetaData(object = inf_filtered_feature_bc_matrix, metadata = infected.percent.viral, col.name = "Percent.camel229E")
inf_filtered_feature_bc_matrix[["percent.mt"]] <- PercentageFeatureSet(inf_filtered_feature_bc_matrix, pattern = "^KEF")
inf_filtered_feature_bc_matrix <- AddMetaData(inf_filtered_feature_bc_matrix, "dcCoV-ACN4", col.name = "Treat")

head(inf_filtered_feature_bc_matrix@meta.data)

mock_filtered_feature_bc_matrix <- AddMetaData(object = mock_filtered_feature_bc_matrix, metadata = mock.total.viral.counts, col.name = "Total.camel229E.Counts")
mock_filtered_feature_bc_matrix <- AddMetaData(object = mock_filtered_feature_bc_matrix, metadata = mock.percent.viral, col.name = "Percent.camel229E")
...
plot(sort(Infected_viral_percentage), ylim = c(0, 0.002), xlim = c(0, 6000), xlab='cell', main='camel229E.Percentage vs cell (ordered) - L.glama camel229E infected')
plot(sort(Mock_viral_percentage), xlim = c(0, 6000), xlab='cell', main='camel229E.Percentage vs cell (ordered) - L. glama camel229E Mock')
...
camel229E_infected_percentage$group = ifelse(camel229E_infected_percentage$Percent.camel229E_log10 <= min.all[3], 'Non-infected', ifelse(camel229E_infected_percentage$Percent.camel229E_log10, 'Infected'))
mock_percentage$group = ifelse(mock_percentage$Percent.camel229E_log10 <= min.all[3], 'Non-infected', ifelse(mock_percentage$Percent.camel229E_log10, 'Infected'))
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/threshold_camel229E_infection.png",
...
inf_filtered_feature_bc_matrix@meta.data <- inf_filtered_feature_bc_matrix@meta.data %>% mutate(Status = case_when(Percent.camel229E > 0.002235588 ~ "Infected",
                                                                                                                   Percent.camel229E <= 0.002235588 ~ "Non-infected"))
...
#Plots for QC
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/cell_numbers_per_virus_before_filtering.png",
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/UMI_per_cell_density_log_before_filtering.png",
    width=600, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/genes_per_cell_density_log_before_filtering.png",
    width=600, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/complexity_log_before_filtering.png",
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/Mitochondrial_content_density_before_filtering.png",
    width=700, height=500)
metadata %>% 
...
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/correlation_gene_UMI_log_before_filtering.png",
...
camel229E.list <- lapply(X = camel229E.list, FUN = function(x) {
  ...
  x <- SCTransform(x, method = "glmGamPoi", vars.to.regress = c("Percent.camel229E", "S.Score", "G2M.Score", "percent.mt"), verbose = FALSE)
})
...
head(camel229E.combined@meta.data)
###################################################################################################################
...
#Plots for QC
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/cell_numbers_per_virus_after_filtering.png",
    width=600, height=500)
metadata_count %>% 
  ggplot(aes(x=Treat, y=n, fill=Status)) + 
  geom_col() +
...
#Number of UMI (transcripts) per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/UMI_per_cell_density_log_after_filtering.png",
    width=600, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=nUMI, fill= Treat)) + 
  geom_density(alpha = 0.6) + 
...
#Number of Genes per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/genes_per_cell_density_log_after_filtering.png",
    width=600, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=nGene, fill= Treat)) + 
  geom_density(alpha = 0.6) +
...
#Complexity
# Visualize the overall complexity of the gene expression by visualizing the genes detected per UMI (novelty score)
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/complexity_log_after_filtering.png",
    width=700, height=500)
metadata %>%
  ggplot(aes(x=log10GenesPerUMI, color = Treat, fill=Treat)) +
  geom_density(alpha = 0.6) +
...
# Visualize the distribution of mitochondrial gene expression detected per cell
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/Mitochondrial_content_density_after_filtering.png",
    width=700, height=500)
metadata %>% 
  ggplot(aes(color=Treat, x=percent.mt, fill=Treat)) + 
  geom_density(alpha = 0.6) + 
...
# Visualize the correlation between genes detected and number of UMIs and determine whether strong presence of cells with low numbers of genes/UMIs
png(file="C:/Users/veraf/OneDrive - Universitaet Bern/Single_Cell_CoV/Analysis/scRNA_seq/figures/Llama_alpaca_camel229E/correlation_gene_UMI_log_after_filtering.png",
    width=1000, height=500)
metadata %>% 
  ggplot(aes(x=nUMI, y=nGene, color = Treat)) + 
  geom_point() + 
